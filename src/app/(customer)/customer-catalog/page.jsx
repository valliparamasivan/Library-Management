...
const CustomerCatalogPage = async ({ searchParams }) => {
    ...
    const booksList = await getCustomerCatalogList(apiParams);
    return <CustomerCatalogSection booksList={booksList} languages={languages} bookCategories={bookCategories} />
}
