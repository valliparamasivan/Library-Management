...
const DashboardPagination = ({ 
  ...
  // Customer module primary color
  const primaryColor = "#0B63CE";
  const primaryHoverColor = "#0a5ab8";
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="h-8 px-3 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-[#0B63CE]/10 hover:border-[#0B63CE] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Previous
          </Button>
              ...
              <Button
                ...
                className={`h-8 w-8 p-0 rounded-lg ${
                  isActive
                    ...
                    : "bg-white border border-gray-300 text-gray-700 hover:bg-[#0B63CE]/10 hover:border-[#0B63CE]"
