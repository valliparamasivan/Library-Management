...
const RenewSuccessPopup = ({ isOpen, onOpenChange, item }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent hideClose className="w-[calc(100%-2rem)] sm:max-w-xl rounded-xl p-0 border-0 max-h-[90vh] overflow-hidden flex flex-col shadow-lg">
        ...
        <div className="px-3 sm:px-4 md:px-5 pt-0 pb-0 flex flex-col">
          <div className="flex flex-col items-center text-center mb-2">
            <div className="space-y-1">
              <p className="text-lg font-medium text-[#1A1A1A] m-0">1 Book Due date Renewed</p>
...
export default RenewSuccessPopup;
