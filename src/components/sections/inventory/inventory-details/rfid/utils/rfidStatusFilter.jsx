...
const RfidStatusFilter = () => {
    ...
    const filterOptions = [
        ...
        { label: "Tagged", value: 2 },
        { label: "Untagged", value: 3 },
        { label: "Printed Unmapped", value: 4 },
    ];
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    ...
                    <span className="text-[#00796B]">{filterOptions.find((o) => o.value === currentFilter)?.label || "All Books"}</span>
...
export default RfidStatusFilter;
