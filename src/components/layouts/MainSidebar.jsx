...
import {  GalleryVerticalEnd, Settings ,LayoutDashboard,RefreshCw,ArrowUpDown ,User,BookMinus,ChartColumnBig,History, CircleDollarSign, Star, CalendarClock } from "lucide-react";
...
const allNavItems = [
  ...
  { title: "Book Reviews", url: "/book-reviews", icon: Star, isStandalone: true },
  { title: "Reserved Books", url: "/reserved-books", icon: CalendarClock, isStandalone: true },
